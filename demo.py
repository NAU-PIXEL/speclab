...
Steps
-----
0. (Optional) Build a custom endmember library interactively with SpeclibViewer,
...
# --- Endmember library -------------------------------------------------------
# Set USE_SPECLIBVIEWER = True to launch SpeclibViewer and build a custom library.
...
# =============================================================================
# STEP 2 (optional) — Build endmember library with SpeclibViewer
# =============================================================================

if USE_SPECLIBVIEWER:
    print("\nLaunching SpeclibViewer — build your album and use 'Export Album' to save.")
    app = SpeclibViewer()
    app.wait_window()
