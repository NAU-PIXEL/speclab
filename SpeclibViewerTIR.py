#!/usr/bin/env python3
"""
SpeclibViewerTIR — GUI browser and endmember selector for the ASU thermal
...
# Allow running directly as a script (`python speclab/SpeclibViewerTIR.py`) in
# addition to the normal entry points (`speclib-viewer-TIR`, `python -m speclab.SpeclibViewerTIR`).
...
def _load_hdf(path: str) -> dict:
    ...
    * **Per-spectrum** (``saveDVhdf`` / SpeclibViewerTIR export) — one sub-group
...
class SpeclibViewerTIR(tk.Toplevel):
    ...
    def __init__(self, master: tk.Misc | None = None) -> None:
        ...
        self.title(f'SpeclibViewerTIR  v{__version__}')
